...
Versión actual: **V0.1.3 en pruebas**. No es una herramienta asistencial definitiva; debe validarse en piloto antes de usarse como referencia operativa.
...
- Edición visual de cada celda para aplicar vacaciones, libre disposición o sustituir el turno previsto por cualquier turno activo del catálogo.
- Trazabilidad del turno base y recálculo por turno aplicado de horas, presencia, noches efectivas, jornada objetivo y resúmenes.
